                     ...
                     bool& zscore, int& permutations, int&minSetSize, double& corrSetAbundance, int& correlatedSetMode)
{
    try
    {
        ...
        desc.add_options()
            ...
            ("correlationSetAbundance,a", value<double>(&corrSetAbundance)->default_value(0.05), "Abundance of correlations sets. This is a filter\
            ...
            ("correlatedSetMode,q", value<int>(&correlatedSetMode)->default_value(0), "mode to detect correlated set: 0=connected components\
