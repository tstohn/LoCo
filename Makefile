...
test_run_loco_sigmoidal:
	./bin/loco -i ./test/data_1.tsv -o bin/ -p data_1 -c -n 100 -s 50 -x 0.4 -z 1 -t 50 -m 2 -q 2 -a 0.01 -u 1000 -f 0
...
test_loco_uniform:
	./bin/loco -i ./test/data_2.tsv -o bin/ -p data_2 -c -n 1000 -s 100 -x 0.5 -z 1 -t 10 -f 20 -v test/paperCellstateMarkers.txt -w test/paperCellsignalMarkers.txt
